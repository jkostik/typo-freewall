...
$TCA['tx_freewall_domain_model_images'] = array(
    'ctrl' => $TCA['tx_freewall_domain_model_images']['ctrl'],
    'interface' => array(
    ...
    'columns' => array(
        ...
        'title' => array(
            'exclude' => 0,
            'label' => 'LLL:EXT:freewall/Resources/Private/Language/locallang_db.xml:tx_freewall_domain_model_images.title',
            'config' => array(
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
...
//            'l10n_cat' => 'text',
//            'exclude' => 0,
//            'label' => 'LLL:EXT:freewall/Resources/Private/Language/locallang_db.xml:tx_freewall_domain_model_images.description',
//            'config' => array(
//                'type' => 'text',
//                'cols' => 40,
//                'rows' => 10,
...
//        ),
        'image' => array(
            'exclude' => 0,
            'l10n_mode' => 'mergeIfNotBlank',
            'label' => 'LLL:EXT:freewall/Resources/Private/Language/locallang_db.xml:tx_freewall_domain_model_images.image',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                ...
                array(
                    ...
                    'maxitems' => 1,
                    'appearance' => array(
                        'createNewRelationLinkTitle' => 'LLL:EXT:freewall/Resources/Private/Language/locallang.xml:add_image',
                        'showAllLocalizationLink' => 1,
                    ),
                    'foreign_match_fields' => array(
                        'fieldname' => 'image',
                        'tablenames' => 'tx_freewall_domain_model_images',
